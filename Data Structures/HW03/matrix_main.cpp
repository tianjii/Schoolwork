...
void SimpleTest(){  //well behaved getrow/read after
	...
	std::cout << "ORIGINAL: "<<std::endl<<m11<<std::endl;
...
void StudentTest(){
	...
	assert(m11.get(1,0,d0));
	assert(double_compare(d0,9));
	assert(m11.get(1,1,d0));
	assert(double_compare(d0,10));
	assert(m11.get(1,2,d0));
	assert(double_compare(d0,11));
	assert(m11.get(1,3,d0));
	assert(double_compare(d0,12));

	std::cout<<m11<<std::endl;
	double* d1 = m11.get_row(1);
...
void ExtraCreditTest(){
	...
	m11.resize(1,2,0);
	assert(m11.num_rows()==1);
	assert(m11.num_cols()==2);
	std::cout<<m11<<std::endl;
	m11.resize(5,1,0);
	assert(m11.num_rows()==5);
	assert(m11.num_cols()==1);
	assert(m11.get(4,0,d0));
	assert(d0 == 0.0);

	std::cout<<m11<<std::endl;
	m11.resize(5,5,4);
	assert(m11.num_rows()==5);
	assert(m11.num_cols()==5);
	assert(m11.get(4,4,d0));
	assert(d0 == 4.0);
	std::cout<<m11<<std::endl;

	m11.resize(0,0,1);
	assert(m11.num_rows()==0);
	assert(m11.num_cols()==0);
	std::cout<<m11<<std::endl;
 ...
 *  See how much harder it makes it to follow the code?mat
